...
class BalanceController extends BaseController
{
    ...
    public function GetAllBalances()
    {
        try {
            ...
            $where = ['book_check_balances.active_id' => $GLOBALS['enable']];
            $balances = DB::table('book_check_balances')
                ->select('book_check_balances.id', 'book_offer_id', 'offers.offer_name_en', 'book_time_type',
                    'book_offer_date', 'book_offer_guest as book_offer_last_guest', 'book_offer_balance', 'actives.active')
    ...
    public function GetBalance($offer_id, $offer_date, $offer_time_type)
    {
        try {
            ...
            $where = ['book_offer_id' => $offer_id, 'book_offer_date' => $offer_date, 'book_time_type' => $offer_time_type, 'book_check_balances.active_id' => $GLOBALS['enable']];
            $balances = DB::table('book_check_balances')
                ->select('book_check_balances.id', 'book_offer_id', 'offers.offer_name_en', 'book_time_type',
                    'book_offer_date', 'book_offer_guest as book_offer_last_guest', 'book_offer_balance', 'actives.active')
                ->join('offers', 'book_check_balances.book_offer_id', '=', 'offers.id')
